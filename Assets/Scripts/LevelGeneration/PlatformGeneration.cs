...
public class PlatformGeneration : MonoBehaviour
{
    ...
    public int pool1Limit;
    public int pool2Limit;
    ...
    private void Update()
    {
        pool1Limit = pool1.poolLimit;
        pool2Limit = pool2.poolLimit;
    ...
    void GenerateNextBlock2()
    {
        for (int i = 0; i < pool2.poolLimit; i++)
        {
            ...
            if (!starts.platformPool[startsCounter].gameObject.activeInHierarchy)
            {
